...
# from monnify.monnify import get_token
...
x = MonnifyCredential(api_key, secret_key, contractCode, walletId, is_live=False)
...
# bank_verify = reserve.verify_account(x, accountNumber='0020657879', bankCode='044')
# print(bank_verify)
...
# walletBal = reserve.get_wallet_balance(x)
# print(walletBal)
...
refund_money = reserve.initiate_refund(x, refundReference='6637whhhwe', transactionReference='MNFY|96|20210918092618|000615', refundAmount='1000.0', refundReason='Order cancelled!', customerNote='Canceled', destinationAccountNumber='2211440871', destinationAccountBankCode='057')
print(refund_money)
